...
תמחור: Free ₪0 לצמיתות (פרויקט אחד, עד 3 משתמשים, תיעוד + PDF בסיסי, ללא כרטיס אשראי) · Starter ₪149/חודש (עד 3 פרויקטים, 10 משתמשים, PDF מקצועי, ייצוא אקסל/CSV, תמיכה במייל 48ש') · Pro ₪349/חודש — הכי פופולרי (עד 100 פרויקטים, 50 משתמשים, PDF עם לוגו, תוכניות קומה, דשבורד מנהל, הרשאות לפי תפקיד, תמיכה מועדפת, התראות תאריך יעד במייל — 3 ימים לפני/יום לפני/ביום היעד, כל משתמש בוחר אישית אם להפעיל) · Enterprise ₪890/חודש + ₪990 הקמה (ללא הגבלת פרויקטים, עד 200 משתמשים, עוזר AI בבטא לשאלות/ניתוח/סינון/ייצוא ליקויים בפרויקט, מיתוג ארגוני, אינטגרציות למערכות ארגוניות לפי אפיון והיקף ההטמעה, ליווי אישי בהקמה ובהטמעת הצוות, תמיכה מועדפת). חיוב שנתי חוסך 20%. אפשר גם ללא מנוי: פרויקט בודד ₪199 (3 חודשים, עד 10 משתמשים), חבילת 3 פרויקטים ₪499 (6 חודשים), חבילת 10 פרויקטים ₪1,290 (שנה). חבילות אקסטרה: +10 פרויקטים ₪79/חודש, +25 פרויקטים ₪149/חודש, +10 משתמשים ₪59/חודש, +50 משתמשים ₪199/חודש (Enterprise). אין התחייבות, ביטול בכל עת, מנוי שנתי מקבל זיכוי יחסי.
...
עוזר AI: זמין ב-Enterprise בלבד, כרגע בגרסת Beta. עונה על שאלות וניתוחים מורכבים על הפרויקט הפעיל, משווה ומפלח נתונים, מפעיל סינון מצטבר ומכין ייצוא PDF/Excel/CSV לאישור המשתמש. הוא אינו מבצע עדכון/יצירה/מחיקה של ליקויים בעצמו.
