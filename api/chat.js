...
עבודה עם קליטה חלשה: האפליקציה (המעטפת/הדפים) יכולה להיטען גם עם קליטה חלשה בזכות cache בדפדפן. פעולות ששומרות נתונים (יצירה או עדכון ליקוי, העלאת תמונה, שינוי סטטוס) דורשות חיבור אינטרנט פעיל כדי להישמר בשרת. סנכרון מלא לעבודה אופליין-first עדיין אינו זמין.
